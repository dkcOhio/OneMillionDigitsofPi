...
2. Python Code
A. The python code relies on the mpmath module to take care of the large number of digits. Note that I set the precision to 1,000,100 instead of just 1M. This was necessary to take care of compounding rounding errors in the last digits. The program takes 2 minutes and 11 seconds to calculate 1M digits on an Intel i5 at 2.9GHz.
